...
from transformers import AutoConfig, GPT2ForSequenceClassification, get_linear_schedule_with_warmup, AutoTokenizer
...
def main():
    ...
    model_tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=True)
    model_tokenizer.pad_token = model_tokenizer.eos_token
    cfg.pad_token_id = model_tokenizer.pad_token_id
